...
function () {
  function User() {
    this.name = "Bekjon";
    this.location = {
      lat: (0, utils_1.default)(90),
      lng: (0, utils_1.default)(90)
    };
  }
...
exports.User = User;
},{"./utils":"src/utils.ts"}],"src/Company.ts":[function(require,module,exports) {
"use strict";
...
},{"./utils":"src/utils.ts"}],"src/customMap.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  customMap.prototype.userMarker = function (mapable) {
    var _this = this;
...
var customer = new customMap_1.customMap("map");
customer.userMarker(user);
customer.userMarker(company); // AIzaSyApBNmPiRUlPAtsCzT7CM0pJga4YfGTojY
